 ...
 * {@code "payment"} back to PascalCase {@code "Payment"}, this harness routes to
 * {@code Payment.events} and the assertion in {@link OutboxRoutingRegressionTest} fails - which is
 * the whole point.
 *
