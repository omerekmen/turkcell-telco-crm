 ...
 * {@code "order"} back to PascalCase {@code "Order"}, this harness routes to {@code Order.events}
 * and the assertion in {@link OutboxRoutingRegressionTest} fails - which is the whole point.
 *
